...
## preFlight Slicer Integration

The script also supports G-code generated by [preFlight](https://github.com/Rcol/preFlight). (Initial support, need testers!)

### Setup

Add these markers to your **Machine start G-code** and **Machine end G-code**:

- End of **Machine start G-code**: `; MZ FLOW TEMP START`
- Beginning of **Machine end G-code**: `; MZ FLOW TEMP END`
...
|---------------------|---------|
| `; temperature = 230` | `nozzle_temperature_range_high` |
